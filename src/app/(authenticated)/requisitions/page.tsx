          ...
          <table className="w-full min-w-[720px] text-xs">
            <thead className="bg-slate-50/80 border-b border-slate-200 text-slate-500 font-medium">
              <tr className="text-left">
                ...
                <th className="hidden px-4 py-2.5 md:table-cell">Project / Cost Center</th>
                <th className="px-4 py-2.5">Value</th>
                <th className="px-4 py-2.5">Budget</th>
                <th className="hidden px-4 py-2.5 sm:table-cell">Needed by</th>
              ...
              {rows.map((r) => (
                <tr key={r.id} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <Link
                      href={`/requisitions/${r.id}`}
                      className="font-medium text-slate-900 hover:text-[#0001FF] transition-colors"
                    >
                      {r.title}
                    </Link>
                  </td>
