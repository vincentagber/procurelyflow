...
import { Printer, FileEdit, History } from "lucide-react";
    ...
    <div className="space-y-4 pb-12 font-sans">
      <div className="flex flex-wrap items-center justify-between gap-2 print:hidden">
        ...
        <div className="flex items-center gap-2">
          {canAmend && (po.status as string) !== "cancelled" && (po.status as string) !== "rejected" ? (
            <Button
              variant="outline"
              className="h-10 border-amber-200 bg-amber-50/60 hover:bg-amber-100 text-amber-900 font-semibold cursor-pointer"
      ...
      <article className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xs">
        ...
        <div className="space-y-6 px-6 py-6 sm:px-8">
          ...
          {/* Change Order History & Revisions (FR-5.4) */}
