...
export default function DashboardPage() {
  ...
  const [timeframe] = useState<"This Month" | "Last 30 Days" | "All Time">("This Month");
  ...
  useEffect(() => {
    const channel = supabase
      .channel("dashboard_realtime_updates_next")
      ...
      <motion.div variants={staggerContainer} className="grid gap-4 lg:grid-cols-12">
        ...
        >
          ...
          <div className="relative my-4 h-24 w-full">
            ...
            >
              <defs>
                <linearGradient id="curveGradientNext" x1="0" y1="0" x2="0" y2="1">
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              action={
                ...
                >
                  <Link href="/requisitions/new">Raise First Request</Link>
                </Button>
              }
            />
          ) : (
    ...
    >
      <div className="flex items-start gap-2.5">
        ...
        <div className="min-w-0">
          <Link href={to} className="text-xs font-bold text-[#111315] hover:underline">
            {label}
          </Link>
