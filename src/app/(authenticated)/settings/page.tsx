    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-7 shadow-xs">
        ...
        <form onSubmit={handleSubmit} className="mt-6 max-w-xl space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="next-settings-full-name" className="text-xs font-medium text-slate-700 flex items-center gap-1.5">
                <User className="h-3.5 w-3.5 text-slate-400" />
                <span>Official Full Name *</span>
              </Label>
              <Input
                id="next-settings-full-name"
                type="text"
                required
                value={fullName}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="next-settings-department" className="text-xs font-medium text-slate-700 flex items-center gap-1.5">
                <Building2 className="h-3.5 w-3.5 text-slate-400" />
                <span>Department / Unit</span>
              </Label>
              <Input
                id="next-settings-department"
                type="text"
                value={department}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="next-settings-email" className="text-xs font-medium text-slate-700 flex items-center gap-1.5">
                <Mail className="h-3.5 w-3.5 text-slate-400" />
                <span>Authentication Email Address</span>
              </Label>
              <Input
                id="next-settings-email"
                type="email"
                disabled
                value={me.data?.email || ""}
