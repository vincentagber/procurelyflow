...
export default function InvoicesPage() {
  ...
  const createInvoice = useMutation({
    mutationFn: async () => {
      if (!invoiceNumber.trim() || !amount) {
        throw new Error("Invoice number and total amount are mandatory.");
      }
    ...
    onSuccess: async () => {
      toast.success("Supplier invoice logged & queued for three-way reconciliation.");
  ...
  const recordPay = useMutation({
    ...
    onSuccess: async () => {
      toast.success("Payment confirmed and invoice marked as settled.");
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-6 sm:p-7 shadow-xs">
        <div>
          ...
          <p className="mt-1 text-xs sm:text-sm text-slate-500">
            Reconcile purchase orders, warehouse delivery receipts (GRN), and supplier invoices before payment release.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          <Button
            ...
            className="h-9 px-4 rounded-lg text-xs font-medium bg-[#0B1457] hover:bg-[#0001FF] text-white shadow-xs gap-1.5 transition-colors"
          >
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Approved line-item quantity, price limits, and contracted unit rate.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 border-t sm:border-t-0 sm:border-l border-slate-100 pt-3 sm:pt-0 sm:pl-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Warehouse physical receipt confirmation and condition inspection sign-off.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 border-t sm:border-t-0 sm:border-l border-slate-100 pt-3 sm:pt-0 sm:pl-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">NRS TIN validation, 7.5% Standard VAT, and statutory 2% WHT clearance.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="grid gap-6 lg:grid-cols-12">
              ...
              >
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="space-y-1.5">
                    <Label htmlFor="inv-number-modal" className="text-xs font-medium text-slate-700">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="inv-due-modal" className="text-xs font-medium text-slate-700">
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  <div className="space-y-1.5 sm:col-span-2">
                    <Label htmlFor="inv-amt-modal" className="text-xs font-medium text-slate-700">
                      Gross Billed Amount
                    </Label>
                ...
                <div className="grid gap-3 sm:grid-cols-2 pt-1">
                  <div className="space-y-1.5">
                    <Label htmlFor="s-name-modal" className="text-xs font-medium text-slate-700">
                      Seller Legal Entity
                    </Label>
                    <Input
                      id="s-name-modal"
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="s-tin-modal" className="text-xs font-medium text-slate-700">
                      Seller Tax ID (TIN)
                    </Label>
                    <Input
                      id="s-tin-modal"
