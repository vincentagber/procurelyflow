    ...
    <div className="space-y-6 pb-16 max-w-7xl mx-auto">
        ...
        {editable && (
          ...
          >
            ...
            <div className="space-y-1.5">
              <Label htmlFor="s-name-app" className="text-xs font-semibold text-slate-700">
                Company / Legal Name
              </Label>
              <Input
                id="s-name-app"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="s-contact-app" className="text-xs font-semibold text-slate-700">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="s-email-app" className="text-xs font-semibold text-slate-700">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="s-phone-app" className="text-xs font-semibold text-slate-700">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="s-tax-app" className="text-xs font-semibold text-slate-700">
      ...
      >
        <DialogContent className="w-[95vw] sm:max-w-lg p-5 sm:p-6 rounded-2xl border border-slate-200 bg-white shadow-xl">
          ...
          >
            <div className="space-y-1.5">
              <Label htmlFor="edit-name-app" className="text-xs font-semibold text-slate-700">
                Company / Legal Name
              </Label>
              <Input
                id="edit-name-app"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="edit-contact-app" className="text-xs font-semibold text-slate-700">
                Contact Person
              </Label>
              <Input
                id="edit-contact-app"
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="space-y-1.5">
                <Label htmlFor="edit-email-app" className="text-xs font-semibold text-slate-700">
                  Email Address
                </Label>
                <Input
                  id="edit-email-app"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="edit-phone-app" className="text-xs font-semibold text-slate-700">
                  Phone / WhatsApp
                </Label>
                <Input
                  id="edit-phone-app"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="edit-tax-app" className="text-xs font-semibold text-slate-700">
                Tax ID / RC Number
              </Label>
              <Input
                id="edit-tax-app"
