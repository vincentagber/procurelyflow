...
function Projects() {
  ...
  return (
    ...
    >
        ...
        >
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <h2 className="text-base font-semibold text-slate-900 tracking-tight">
              Create Project / Cost Center
            </h2>
            <p className="text-xs text-slate-500 font-normal">
              Track departmental allocations and spend limits
            </p>
          </div>
          <div className="grid gap-4 md:grid-cols-3 pt-1">
            <div className="space-y-1.5">
              <Label htmlFor="p-name" className="text-xs font-medium text-slate-700">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="p-loc" className="text-xs font-medium text-slate-700">
                Location (optional)
              </Label>
              <Input
                id="p-loc"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="p-budget" className="text-xs font-medium text-slate-700">
          ...
          <div className="flex justify-end pt-1">
            <Button
              className="h-9 px-5 rounded-lg bg-[#0B1457] hover:bg-[#0001FF] text-xs font-semibold text-white shadow-xs cursor-pointer disabled:opacity-50"
      ...
      {isLoading ? (
        <p className="text-xs text-slate-500 py-12 text-center animate-pulse">
          Loading projects / cost centers…
        </p>
      ) : !data?.length ? (
        <EmptyState
                ...
                {totalBudget > 0 && (
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs text-slate-500 tabular-nums">
                      <span>
                        Committed:{" "}
                        <strong className="font-semibold text-slate-700">{money(committed)}</strong>
                      </span>
                      <span>
                        Budget:{" "}
      ...
      >
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 pt-1">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-3.5 shadow-2xs">
              <span className="text-[11px] font-medium text-slate-500">Issued POs</span>
              <p className="mt-1 text-base font-semibold tabular-nums text-slate-900">
                ...
                {isLoadingDetails ? (
                  ...
                  <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-6 text-center">
                    ...
                    <p className="mt-1 text-[11px] text-[#4B556D] max-w-sm mx-auto">
                      Field and department material requests tagged to this project will appear here
                      with live threshold sign-off status.
                    </p>
                    <Button
                      asChild
                      size="sm"
              ...
              <div>
                {isLoadingDetails ? (
                  ...
                  <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-6 text-center">
                    ...
                    <p className="mt-1 text-[11px] text-[#4B556D] max-w-sm mx-auto">
                      Binding purchase orders issued to suppliers for this project will be recorded
                      here with delivery milestones.
                    </p>
                  </div>
                ) : (
                  <div className="divide-y divide-[#E2E8F0] rounded-xl border border-[#E2E8F0] bg-white overflow-hidden">
